...
public class AppConstant {
    ...
    public static final String DOCTOR_GET_ALL = "/api/doctor/getAll";
    ...
    public static final String DOCTOR_APPOINTMENT_GET = "/api/hms/doctor/appointment/get";
    public static final String PATIENT_UPCOMING_APPOINTMENTS = "/api/hms/doctor/appointment/get/patient/upcoming";
    public static final String DOCTOR_FREE_SLOT = "/api/hms/doctor/appointment/doctor/{userId}/freeSlot/{date}";
    public static final String DOCTOR_DASHBOARD = "/api/hms/doctor/appointment/dashboard";
